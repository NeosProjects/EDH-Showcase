<template>
  <div class="px-4 md:px-64 pb-8">
    <section class="card mb-8">
      <span class="text-4xl font-bold mb-4">Contact</span>
      <div class="flex flex-col gap-4 text-xl">
        <div class="flex items-center gap-4">
          <Icon icon="envelope" class="text-primary text-2xl" />
          <span>Email : <a href="mailto:contact@ecoledelhetre.fr" class="text-primary-500 hover:underline">ecoledelhetre@gmail.com</a></span>
        </div>
        <div class="flex items-center gap-4">
          <Icon icon="phone" class="text-primary text-2xl" />
          <span>Téléphone : <a href="tel:+33512345678" class="text-primary-500 hover:underline">06 13 30 45 14</a></span>
        </div>
        <div class="flex items-center gap-4">
          <Icon :icon="['fab', 'instagram']" class="text-primary text-2xl" />
          <span>Instagram : <a href="https://instagram.com/ecole_collegedelhetre" target="_blank" class="text-primary-500 hover:underline">@ecole_collegedelhetre</a></span>
        </div>
        <div class="flex items-center gap-4">
          <Icon :icon="['fab', 'facebook']" class="text-primary text-2xl" />
          <span>Facebook : <a href="https://www.facebook.com/ecolecollegedelhetre" target="_blank" class="text-primary-500 hover:underline">facebook.com/ecolecollegedelhetre</a></span>
        </div>
        <div class="flex items-center gap-4">
          <Icon :icon="['fab', 'youtube']" class="text-primary text-2xl" />
          <span>YouTube : <a href="https://youtube.com/@ecoledelhetre" target="_blank" class="text-primary-500 hover:underline">@ecoledelhetre</a></span>
        </div>
      </div>
    </section>
    ...
    <section class="card mb-8 flex flex-col gap-4">
      <span class="text-4xl font-bold mb-4 text-center">On vous accueille avec le sourire</span>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div
          ...
          :key="member.name"
          class="flex flex-col items-center gap-3 p-4 bg-white rounded-lg"
        >
          <img 
            v-if="member.img"
            :src="member.img" 
          ...
          <div v-else class="w-32 h-32 rounded-full bg-gray-300 flex items-center justify-center">
            <span class="text-gray-500 text-sm">Pas de photo</span>
          </div>
          <div class="flex flex-col items-center text-center">
            <span class="font-bold text-lg">{{ member.name }}</span>
            <span class="text-sm text-gray-600">{{ member.profession }}</span>
          </div>
        </div>
      </div>
    </section>
